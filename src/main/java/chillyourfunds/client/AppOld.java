...
public class AppOld extends javafx.application.Application{
    ...
    void initialize(){
        ...
        System.out.println("Stan konta "+person1.getName()+" wynosi "+person1.getBalance(group)+"$");
        System.out.println("Stan konta "+person2.getName()+" wynosi "+person2.getBalance(group)+"$");
        System.out.println("Stan konta "+person3.getName()+" wynosi "+person3.getBalance(group)+"$");
        System.out.println("Stan konta "+person4.getName()+" wynosi "+person4.getBalance(group)+"$");
    }
